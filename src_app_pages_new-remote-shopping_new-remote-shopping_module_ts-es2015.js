...
function RemoteOrderComponent_tr_40_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function RemoteOrderComponent_tr_40_Template_i_click_26_listener() { const restoredCtx = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵrestoreView"](_r5); const item_r2 = restoredCtx.$implicit; const ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵnextContext"](); return ctx_r4.toGenerateReceipt(item_r2.orderId); });
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
} if (rf & 2) {
...
RemoteOrderComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({ type: RemoteOrderComponent, selectors: [["app-remote-order"]], decls: 42, vars: 9, consts: [[1, "container-fluid"], [1, "row"], [1, "col"], [1, "col", "headerAlignment"], ["appearance", "outline", 1, "example-full-width"], ["type", "text", "matInput", "", "placeholder", "Party Name", 3, "ngModel", "ngModelChange", "change"], [1, "iconcalender", "p-1"], ["appearance", "outline", 1, "example-full-width", 2, "font-size", "12px"], ["matInput", "", "required", "", "ngModel", "", "bsDatepicker", "", "placeholder", "Receipt Date.", "id", "datePicker", "bsDatepicker", "", 2, "text-transform", "uppercase!important", "height", "22px", 3, "maxDate", "ngModel", "bsConfig", "ngModelOptions", "ngModelChange"], [1, "my-0", "py-0"], [1, "row", 2, "width", "100%", "overflow-x", "scroll"], [1, "table", "table-responsive", "table-bordered", "fs--1", "mb-0"], [1, "text-900", "text-center"], [1, "btn-reveal-trigger"], ["scope", "col"], ["type", "checkbox"], [1, "text-nowrap"], [1, "text-center"], ["style", "color: #676398 !important", 3, "ngStyle", 4, "ngFor", "ngForOf"], [4, "ngIf"], [2, "color", "#676398 !important", 3, "ngStyle"], ["scope", "row", 2, "vertical-align", "middle"], [2, "vertical-align", "middle"], [1, "text-nowrap", 2, "vertical-align", "middle"], [1, "text-center", 2, "vertical-align", "middle"], [1, "fas", "fa-receipt", 3, "click"], ["colspan", "12"], ["src", "assets/img/icons/spot-illustrations/GST No Transaction.png", "width", "124", "height", "142", "alt", "", 1, "image-responsive"], [1, "text-nowrap", "pt-2", 2, "font-weight", "600", "color", "#000000"]], template: function RemoteOrderComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("ngModelChange", function RemoteOrderComponent_Template_input_ngModelChange_5_listener($event) { return ctx.searchKey = $event; })("change", function RemoteOrderComponent_Template_input_change_5_listener() { return ctx.getAllRemoteOrderSearch(ctx.searchKey); });
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("ngModelChange", function RemoteOrderComponent_Template_input_ngModelChange_11_listener($event) { return ctx.todaysDate = $event; })("ngModelChange", function RemoteOrderComponent_Template_input_ngModelChange_11_listener($event) { return ctx.changeDate($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
...
SalesNewInvoiceComponent.ɵfac = function SalesNewInvoiceComponent_Factory(t) { return new (t || SalesNewInvoiceComponent)(); };
SalesNewInvoiceComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SalesNewInvoiceComponent, selectors: [["app-sales-new-invoice"]], decls: 2, vars: 0, consts: [[1, "custom-Modal-sale-invoice"]], template: function SalesNewInvoiceComponent_Template(rf, ctx) { if (rf & 1) {
