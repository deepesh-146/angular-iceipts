      ...
      _AddTicketComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
        ...
        template: function AddTicketComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function AddTicketComponent_Template_button_click_25_listener() {
      ...
      function NewticketpageComponent_tr_39_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function NewticketpageComponent_tr_39_Template_span_click_15_listener() {
            ...
            return ctx_r4.getcontact(item_r2.ticketId);
          });
        ...
        _createClass(_NewticketpageComponent, [{
          ...
          value: function getEnquiries(search) {
            ...
            this.contactService.getEnquiriesList({}, this.currentUser.id, this.partyPageSize, this.currentPageNo + 1, this.search).then(function (res) {
              ...
              if (_this4.contactListResponse.length > 0) {
                _this4.toastService.openSnackBar("Record Found Successfully!!!");
              }
            }, function (err) {
              if (err.error.expose) {
      ...
      _NewticketpageComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({
        ...
        template: function NewticketpageComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function NewticketpageComponent_Template_button_click_6_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("ngModelChange", function NewticketpageComponent_Template_input_ngModelChange_15_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function NewticketpageComponent_Template_a_click_55_listener() {
              return ctx.removeTicket();
            });
