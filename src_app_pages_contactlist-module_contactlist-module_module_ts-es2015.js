...
ContactlistModuleModule.ɵmod = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineNgModule"]({ type: ContactlistModuleModule });
ContactlistModuleModule.ɵinj = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineInjector"]({ imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵsetNgModuleScope"](ContactlistModuleModule, { declarations: [_newticketpage_newticketpage_component__WEBPACK_IMPORTED_MODULE_1__.NewticketpageComponent,
        _add_contacform_add_contacform_component__WEBPACK_IMPORTED_MODULE_3__.AddContacformComponent], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_5__.CommonModule,
        _contactlist_module_routing_module__WEBPACK_IMPORTED_MODULE_0__.ContactlistModuleRoutingModule,
        src_app_material_module__WEBPACK_IMPORTED_MODULE_2__.MaterialExampleModule,
        _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormsModule,
        _angular_forms__WEBPACK_IMPORTED_MODULE_6__.ReactiveFormsModule,
        _angular_material_input__WEBPACK_IMPORTED_MODULE_7__.MatInputModule, ngx_bootstrap_datepicker__WEBPACK_IMPORTED_MODULE_8__.BsDatepickerModule] }); })();
...
/* harmony import */ var _add_contacform_add_contacform_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../add-contacform/add-contacform.component */ 53413);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/core */ 2316);
...
function NewticketpageComponent_tr_42_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function NewticketpageComponent_tr_42_Template_span_click_16_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵrestoreView"](_r5); const ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵnextContext"](); return ctx_r4.getcontact(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
...
function NewticketpageComponent_tbody_43_Template(rf, ctx) { if (rf & 1) {
...
const _c0 = function (a0) { return { ranges: a0, showWeekNumbers: false, showNextMonth: false, rangeInputFormat: "DD MMM YYYY", containerClass: "theme-dark-blue", displayOneMonthRange: true }; };
class NewticketpageComponent {
    ...
    openDialog() {
        const dialogRef = this.dialog.open(_add_contacform_add_contacform_component__WEBPACK_IMPORTED_MODULE_1__.AddContacformComponent, {
            width: 'auto',
            height: '730px',
            data: {},
            disableClose: true,
...
NewticketpageComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({ type: NewticketpageComponent, selectors: [["app-newticketpage"]], decls: 60, vars: 8, consts: [[1, "container-fluid", "mb-3", "px-0", "mx-0", "bg-white"], ["id", "headingPrintHide", 1, "row", "pt-2", "pb-3", 2, "display", "flex", "align-items", "center"], [1, "col-6", "d-md-inline-block", "fs--1", "ml-5", 2, "font-weight", "800", "font-size", "20px!important"], [2, "padding", "16px"], [1, "col-6", "navOption-btns", 2, "display", "flex", "justify-content", "flex-end"], ["id", "excelPrintHide", "type", "button", 1, "btn", "me-3", 2, "white-space", "nowrap"], [1, "m-0"], [1, "row", 2, "display", "flex", "align-items", "center", "padding", "15px"], [1, "col-sm-8", "col-md-8", "col-lg-4", "col-xl-3", "mb-0"], ["for", "Date Range", 1, "form-label"], ["appearance", "outline", 1, "example-full-width"], ["matInput", "", "placeholder", "Date Range", "id", "Date Range", "type", "text", "ngModel", "", "bsDaterangepicker", "", 2, "text-transform", "uppercase!important", 3, "outsideClick", "maxDate", "ngModel", "bsConfig", "ngModelChange"], [1, "iconcalender", "p-1"], [1, "col-md-1", "col-lg-5", "col-xl-6"], [1, "col-sm-4", "col-md-3", "col-lg-3", "col-xl-3"], ["type", "search", "id", "searchInput", "placeholder", "Name", 1, "form-control", "pe-5"], [1, "table-container"], [1, "table-div", "overflow-hidden", 2, "overflow-x", "scroll"], [1, "table", "table-responsive", "m-0"], [1, "row"], [1, "col-sm-10"], [1, "row", 2, "text-align", "left"], [1, "col-1", "text-nowrap", "d-flex", "align-items-center", 2, "justify-content", "center"], ["type", "checkbox", 1, "mt-3"], [1, "col", "d-flex", "align-items-center", "m-0", 2, "justify-content", "flex-start"], ["class", "row", "style", "color: #676398!important;", 4, "ngFor", "ngForOf"], [4, "ngIf"], ["id", "errorDeleteSelect-modal", "tabindex", "-1", "role", "dialog", "aria-hidden", "true", 1, "modal", "fade"], ["role", "document", 1, "modal-dialog", "modal-dialog-centered", 2, "max-width", "350px"], [1, "modal-content", "position-relative"], [1, "position-absolute", "top-0", "end-0", "mt-2", "me-2", "z-index-1"], ["data-bs-dismiss", "modal", "aria-label", "Close", 1, "btn-close", "btn", "btn-sm", "btn-circle", "d-flex", "flex-center", "transition-base"], [1, "modal-body", "p-0"], [1, "rounded-top-lg", "py-3", "ps-4", "pe-6", "bg-light"], ["id", "modalExampleDemoLabel", 1, "mb-1", "text-center", "font-weight-bold", 2, "font-weight", "800"], [1, "text-center"], [1, "modal-footer", "justify-content-center"], ["data-bs-dismiss", "modal", 1, "btn", "btn-outline-success"], ["data-bs-dismiss", "modal", 1, "btn", "btn-outline-danger", 3, "click"], [1, "row", 2, "color", "#676398!important"], [1, "col-1", "d-flex", "justify-content-center"], ["type", "checkbox", 1, "mt-2"], [1, "col", "d-flex", "align-items-center"], [1, "col-2"], ["data-bs-toggle", "modal", "data-bs-target", "#errorDelete-modal", 1, "btn", "col-4", "p-0", "m-0"], ["data-bs-toggle", "tooltip", "data-bs-placement", "top", "title", "Delete", 1, "bi-trash", "icon-color", "iconFontSize", 2, "color", "red", 3, "click"], ["colspan", "10"], [1, "text-nowrap"], [1, "nav-link"]], template: function NewticketpageComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("ngModelChange", function NewticketpageComponent_Template_input_ngModelChange_14_listener($event) { return ctx.dateRange = $event; })("ngModelChange", function NewticketpageComponent_Template_input_ngModelChange_14_listener($event) { return ctx.changeDate($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function NewticketpageComponent_Template_button_click_58_listener() { return ctx.deleteContactId(); });
